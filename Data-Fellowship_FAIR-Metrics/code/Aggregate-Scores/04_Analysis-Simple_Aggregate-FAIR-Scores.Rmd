...
```{r}
devtools::source_url("https://raw.github.nceas.ucsb.edu/KNB/arctic-data/master/reporting/R/theme_ADC.R?token=AAAABNUU7WVBRSKNPOHYU3K7SLZQQ")
```
...
```{r, eval=FALSE}
#save plot as JPG to Aurora
ggsave(filename="Figure-07b_2020-10-16_AggregateScores-FAIR-Simple.jpg",
       path=here("figures"),
       bg="transparent",
       dpi = 300,
       units="in",
