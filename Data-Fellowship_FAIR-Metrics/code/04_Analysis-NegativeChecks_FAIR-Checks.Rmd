...
abtract: R packages updated on 2020-10-01. Rmd updated on 2020-10-01.
---
...
Goal: Identify which FAIR checks are deteriorating (i.e., negative 'checkDiff').
...
Goal: Get all PIDs from the check with the top negative score
...
#subset solr query to only those pids that had a negative change score (i.e. deterioration) for "Entity Type Present"
