...
ggsave("../images/dataone-fair-scores-dialect-horiz.png", width = 8, height = 4)
p
```
...
Split results across DataONE repositories.
...
ggsave("../images/dataone-fair-scores-repos.png", width = 8, height = 4)
p
```
